...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		bg = new FlxSprite().loadGraphic(Paths.image('creditscreen'));
		add(bg);
		bg.screenCenter();
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			["Horrorcello Crew"],
			['VirusZeke (Esty)',		'ST',	"Director, Animation, Art, UI Designs, & 3rd Phase Song", 'https://twitter.com/VirusZeke', 'FFFFFF'],
			['PeleePon',		'Pelee',	"Horrorcello AU Creator & Co-Director",	'https://twitter.com/PeleePon',	'FFFFFF'],
